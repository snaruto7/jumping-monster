        ...
        stage('Deploy Application'){
            steps{
                sh """
                    ...
                    kubectl --kubeconfig=${WORKSPACE}/kube-config rollout restart deployment/jumping-monster

                    kubectl --kubeconfig=${WORKSPACE}/kube-config rollout status deployment/jumping-monster
                """
            }
        }
    }
